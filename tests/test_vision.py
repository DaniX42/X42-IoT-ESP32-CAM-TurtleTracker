...
def test_door_entrance_lines_are_vertical():
    ...
    assert np.allclose(near_line[:, 0], 0.24625 * 1600)
    assert np.allclose(far_line[:, 0], 0.48625 * 1600)
    assert np.allclose(near_line[:, 1], [0, 840])
    assert np.allclose(far_line[:, 1], [0, 840])
